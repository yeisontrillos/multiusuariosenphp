...
/* cierre barra de navegacion del usuario */
	...
	<header>
		...
		<?php 
						...
						{
						?>
						<i>  <h2>Bienvenido a rol admin, <?php echo $_SESSION['admin_login'];?></h2></i>
						<?php
...
<table class="table mx-auto"   style="margin: 100px; margin-lef: 200px; width:70%;">
  ...
  <tbody>
    <tr>
	  ...
	  <td>
      <a class="btn btn-info" href="editaradm.php?id=<?php echo $reg['id']; ?> "><i class="fa-solid fa-user-pen"></i>Editar</a>
      </td>
